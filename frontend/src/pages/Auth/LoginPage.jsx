        ...
        <div className="image-section">
          ...
          <div className="image-content">
            ...
            <p className="image-description">
              From the Himalayas to ancient temples, capture every moment of your journey.
            </p>
        ...
        <div className="form-section">
          <div className="form-container">
            <div className="form-header">
              ...
              <p className="form-subtitle">Continue your journey across Nepal</p>
            </div>
                ...
                <div className="input-wrapper">
                  ...
                  >
                    {showPassword ? (
                      ...
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.88 9.88C9.58525 10.1544 9.34903 10.4858 9.1856 10.8538C9.02217 11.2218 8.93488 11.6188 8.92907 12.0211C8.92326 12.4233 8.99908 12.8225 9.15172 13.1945C9.30437 13.5665 9.53047 13.9036 9.816 14.185C10.1015 14.4665 10.4405 14.6867 10.812 14.8327C11.1834 14.9787 11.5795 15.0474 11.9783 15.0348C12.3771 15.0223 12.7695 14.9288 13.1306 14.7599C13.4917 14.5909 13.8139 14.3503 14.077 14.052" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M10.73 5.08C11.1513 5.02751 11.5755 5.00079 12 5C19 5 23 12 23 12C22.552 12.957 21.743 14.155 20.61 15.31" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M6.61 6.61C4.621 8.034 3 10 2 12C2 12 6 20 12 20C13.916 20 15.652 19.263 17.13 18.13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
